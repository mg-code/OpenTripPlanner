...
/**
 * OSM way properties for Latvian roads.
 ...
 */
public class LatviaWayPropertySetSource extends DefaultWayPropertySetSource {
    ...
    public WayPropertySet getWayPropertySet() {
        ...
        /*
         * Automobile speeds in Latvia. General speed limit is 90kph unless signs says otherwise
         * 
         */
        setCarSpeed(props, "highway=motorway", 25); // 90kph
        setCarSpeed(props, "highway=motorway_link", 15); // = 54kph
        setCarSpeed(props, "highway=trunk", 25); // 90kph
        setCarSpeed(props, "highway=trunk_link", 15); // = 54kph
        setCarSpeed(props, "highway=primary", 25); // 80kph
